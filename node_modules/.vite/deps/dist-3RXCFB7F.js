...
var oe = class extends LitElement {
  ...
  async onChangeRoute() {
    await animate(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = N.state.view, animate(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
...
lit-html/development/directives/if-defined.js:
   ...
   *)
*/
//# sourceMappingURL=dist-3RXCFB7F.js.map
